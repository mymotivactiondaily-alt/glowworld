...
export const MASCOT_CONFIG: Record<CountryKey, MascotConfig> = {
  france: {
    ...
    welcomeMessage: "Cocorico ! Salut compatriote ! Je suis GAUL'O, ton compagnon pour vibrer avec les Bleus tout au long de l'Été du Foot 2026.",
  ...
  usa: {
    ...
    welcomeMessage: "Hey buddy! I'm STARZ, your bald eagle companion to cheer for Team USA at the 2026 Football Summer. Let's go!",
  ...
  canada: {
    ...
    welcomeMessage: "Hey buddy, sorry to bother you! I'm HOCK, your friendly beaver. Salut compatriote! On vibre ensemble pour l'Été du Foot 2026 avec Canada Soccer.",
