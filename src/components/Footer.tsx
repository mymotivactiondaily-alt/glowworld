      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-white/50 text-sm mb-6">
            {t._lang === 'fr'
              ? 'Vivez l\'Été du Foot 2026 comme jamais auparavant. La technologie au service de la passion.'
              : t._lang === 'en'
                ? 'Experience the 2026 Football Summer like never before. Technology in the service of passion.'
