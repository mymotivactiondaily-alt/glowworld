            ...
            {cart.length > 0 && (
              <div className="pt-8 border-t border-white/10 mt-auto">
                ...
                <button
                  ...
                  className="w-full bg-france-blue hover:bg-blue-700 disabled:bg-blue-900 disabled:cursor-not-allowed text-white font-black py-4 rounded-xl uppercase tracking-widest transition-all neon-button relative group overflow-hidden flex items-center justify-center gap-2"
                >
                  {isCheckingOut ? (
